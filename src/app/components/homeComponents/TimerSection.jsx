...
const TimerSection = () => {
  return (
    <section className='py-8 bg-indigo-200 bg-gradient dark:bg-gray-800 md:py-16'>
        ...
        <div className='flex flex-col items-center -mx-5 md:flex-row'>
          <div className='w-full px-5 mb-5 text-center md:mb-0 md:text-left'>
            ...
            <div className='w-full mt-4 md:w-44'>
              <button
                type='button'
                className='py-2 px-4 bg-orange-100 hover:bg-gray-100 focus:ring-indigo-500 focus:ring-offset-indigo-200 w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg '
              >
                Early bird
              </button>
            </div>
